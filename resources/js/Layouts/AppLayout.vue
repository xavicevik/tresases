...
<template>
    ...
    <div>
        ...
        <div class="min-h-min bg-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <JetNavLink v-if="$can('users-list')" :href="route('users.index')" :active="route().current('users.index')">
                                    Users
                                </JetNavLink>
                                <JetNavLink v-if="$can('rifas-list')" :href="route('rifas.index')" :active="route().current('rifas.index') || route().current('numerosreservados.index')">
                                    Rifas
                                </JetNavLink>
                                <JetNavLink v-if="$can('ventas-list')" :href="route('ventas.index')" :active="route().current('ventas.index')">
                                    Ventas
                                </JetNavLink>
                                <JetNavLink  v-if="$can('transacciones-list')" :href="route('users.index')" :active="route().current('transacciones.index')">
                                    Transacciones
                                </JetNavLink>
                                <JetNavLink v-if="$can('configuracion-list')" :href="route('master.index')" :active="route().current('master.index')">
                                    Configuracion
                                </JetNavLink>
                                <JetNavLink v-if="$can('configuracion-list')" :href="route('master.index')" :active="route().current('master.index')">
                                    Cajas
                                </JetNavLink>
                                <JetNavLink v-if="usePage().props.value.auth.puntoventa">
                                    Punto de venta : <p class="font-bold">{{ usePage().props.value.auth.puntoventa[0].nombre }}</p>
                                </JetNavLink>

                                <div class="p-2">
                                    <div class="flex h-64 mx-auto justify-center">
                                        <div class="relative ">
                                            ...
                                            <div class="absolute w-full  rounded-b border-t-0 z-10" v-show="isOpenCart">
                                                <div class="shadow-xl w-64 overflow-y-auto h-80">
                                                    <div v-if="showCart" v-for="(dato, id) in showCart" :key="id" class="p-2 flex bg-white hover:bg-gray-100 cursor-pointer border-b border-gray-100" style="">
                                                        <div class="p-2 w-12">
    ...
    <footer class="p-4 bg-white sm:p-6 dark:bg-gray-800">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="https://flowbite.com" class="flex items-center">
                    <img src="/storage/img/logo.jpg" class="mr-3 h-8" alt="FlowBite Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">TresAses</span>
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Rifas</h2>
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Conocenos</h2>
                    <ul class="text-gray-600 dark:text-gray-400">
                        <li class="mb-4">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" class="hover:underline">TresAses™</a>. All Rights Reserved.
            </span>
