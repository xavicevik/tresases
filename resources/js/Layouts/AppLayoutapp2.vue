        ...
        <div class="w-full">
            <header class="top-0 w-full flex items-center p-4 text-semibold text-red-900 bg-white">
                ...
                <div class="flex items-center justify-start md:justify-center pl-3 h-10 border-none">
                    <img class="h-1/2 mr-2 rounded-md overflow-hidden" src="https://therminic2018.eu/wp-content/uploads/2018/07/dummy-avatar.jpg" />
                    <span class="md:block">
                        {{ $page.props.user.username }}
                    </span>

                </div>
                <div class="flex justify-between items-center h-10 header-center">
