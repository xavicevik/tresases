...
function calcularTotal() {
        cart.forEach(function(boleta){
            this.total += boleta.price;
        })
}
*/
                                        ...
                                        <div class="relative ">
                                            ...
                                            <div class="absolute w-full  rounded-b border-t-0 z-10" v-show="isOpenCart">
                                                <div class="shadow-xl w-64 overflow-y-auto h-80">
                                                    <div v-if="cart" v-for="(dato, id) in cart" :key="id" class="p-2 flex bg-white hover:bg-gray-100 cursor-pointer border-b border-gray-100" style="">
                                                        <div class="p-2 w-12">
