                                                ...
                                                <div class="mb-4 w-full">
                                                    <div class="flex py-1 text-xs font-bold align-middle">
                                                        ...
                                                        <div class="w-4/12 px-1">
                                                            {{ asignarMode?'Pagar':'Anular' }}
                                                        </div>
                                                        <div class="w-1/12 px-1">
                                                        </div>
                                                    </div>
                                                    <div v-for="(reserva, index) in form.reservas" :key="reserva.numero" class="bg-blue-200 text-xs rounded-md flex py-1 px-2">
                                                        <div class="w-4/12">
                                                            {{ reserva.numero }}/{{ reserva.promocional}}
                                                        </div>
                                                        <div class="w-3/2 px-1">
                                                            {{ formatPrice(reserva.valortotal) }}
                                                        </div>
                                                        <div class="w-4/12 px-1">
                                                            <money3 v-if="asignarMode" v-bind="configMoney" @focusout="pushSessionDetail(session.id, reserva, 'upd')" :max="reserva.valorsaldo" v-model="reserva.valorpagar" class="h-8 w-full text-xs pl-2 pr-2 rounded-md z-0 focus:shadow focus:outline-none"></money3>
                                                            <money3 v-else v-bind="configMoney" :max="reserva.valoranular" v-model="reserva.valorpagado" class="h-8 w-full text-xs pl-2 pr-2 rounded-md z-0 focus:shadow focus:outline-none"></money3>
                                                        </div>
                                                        <div class="w-1/12 px-1">
                                                    ...
                                                    <div class="bg-blue-400 text-xs rounded-md flex py-1 px-2 font-bold">
                                                        <div class="w-4/12">
                                                            Total:
                                                        </div>
                                                        <div class="w-3/12 px-1">
                            ...
                            <div class="w-full mx-auto pb-5">
                                ...
                                <h1 class="sr-only">Resumen de la transacción</h1>
                                    ...
                                    <div class="mt-5 mb-10 lg:mt-0">
                                        <h2 class="text-sm font-bold font-medium text-gray-900">Resumen de la transacción</h2>
                            ...
                            <div class="max-w-2xl mx-auto lg:max-w-none pb-4">
                                ...
                                <form class="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
                                    <div>
                                        <div class=" mt-5 mb-10 lg:mt-0">
                                            <div class="flex">
                                                <h2 class="text-sm font-bold text-gray-900">Información del cliente</h2>
                                            ...
                                            <div v-show="form.cliente.id" class="mt-2 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                                                <div>
                                                    ...
                                                    <div class="mt-1">
                                                        <input type="text" :disabled="!isNewCliente" :class="{'bg-blue-100' : !isNewCliente}" v-model="form.cliente.nombre" autocomplete="given-name" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-xs sm:text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mt-1">
                                                        <input type="text" :disabled="!isNewCliente" :class="{'bg-blue-100' : !isNewCliente}" v-model="form.cliente.apellido" autocomplete="family-name" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-xs sm:text-sm">
                                                ...
                                                <div class="sm:col-span-2">
                                                    ...
                                                    <div class="mt-1">
                                                        <input type="text" :disabled="!isNewCliente" :class="{'bg-blue-100' : !isNewCliente}" v-model="form.cliente.movil" autocomplete="street-address" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-xs sm:text-sm">
                                                        <div v-if="$page.props.errors.telefono" class="text-red-500">{{ $page.props.errors.telefono }}</div>
                                                    </div>
                                                </div>

                                                <div>
                                                    <label class="block text-xs font-medium text-gray-700">Tipo documento</label>
                                                    <div class="mt-1">
                                                        <select :disabled="!isNewCliente" :class="{'bg-blue-100' : !isNewCliente}" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-xs sm:text-sm" v-model="form.cliente.idtipos_documento">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mt-1">
                                                        <select :disabled="!isNewCliente" :class="{'bg-blue-100' : !isNewCliente}" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-xs sm:text-sm" v-model="form.cliente.idpais" @change="getDepartamentos()">
                                                ...
                                                <div>
                                                    <label class="block text-xs font-medium text-gray-700">Departamento</label>
                                                    <div class="mt-1">
                                                        <select :disabled="!isNewCliente" :class="{'bg-blue-100' : !isNewCliente}" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-xs sm:text-sm" v-model="form.cliente.iddepartamento" @change="getCiudades">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mt-1">
                                                        <select :disabled="!isNewCliente" :class="{'bg-blue-100' : !isNewCliente}" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-xs sm:text-sm" v-model="form.cliente.idciudad">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mt-1">
                                                        <input type="email" :disabled="!isNewCliente" :class="{'bg-blue-100' : !isNewCliente}" v-model="form.cliente.correo" autocomplete="email" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-xs sm:text-sm">
                                            ...
                                            <div class="mt-2 border-t border-gray-200 pt-2">
                                                ...
                                                <fieldset class="mt-2">
                                                    ...
                                                    <div class="p-2 space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                                                        ...
                                                        <div class="flex items-center">
                                                            <input v-model="form.paymentmethod" value="2" type="radio" class="px-2 focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                        ...
                        <div class="fixed z-10 inset-0 overflow-y-auto ease-out duration-400" v-if="isOpenRifa">
                            <div class="flex items-end justify-center pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                ...
                                <div class="inline-block lg:w-7/12 align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
                                    ...
                                    <!-- Tabla de contenido -->
                                    <section>
                                        <div class="lg:px-4 px-2 md:px-2 sm:px-0 py-2 pb-6">
                                            <table class="table-fixed w-full">
                                                <thead>
                                                <tr class="bg-gray-100">
                                                    <th class="px-4 py-2 w-2/12 text-sm font-bold hover:bg-blue-500 hover:text-gray-50 rounded-b">
                                                        <button @click="getRifas('', 'titulo')" class="font-bold">
                                                            Nombre
                                                            <div v-show="sortBy == 'titulo'">
                                                ...
                                                <tr @click="onSelectRifa(rifa)" class="hover:bg-blue-50 text-center" text-sm v-if="existerifa > 0" v-for="(rifa, id) in arrayRifas.data" :key="id">
                                                    <td class="border px-1 py-2 text-sm truncate" v-text="rifa.titulo"></td>
                                                    <td class="border px-1 py-2 text-sm truncate" v-text="dateTime(rifa.fechafin)"></td>
                                                </tr>
                                                <tr v-else>
                                                    <td class="border px-4 py-2 text-xs text-center" colspan="2"> La consulta no obtuvo datos</td>
                                                </tr>
                                                </tbody>
                                            </table>
                                            <section class="mt-6">
                                        ...
                                        <div class="lg:px-4 md:px-2 sm:px-0 py-2 pb-6">
                                            <table class="table-fixed w-full text-xs">
                                                ...
                                                <tr class="bg-gray-100 hover:bg-blue-500 hover:text-gray-50">
                                                    <th class="px-4 py-2 w-2/12 font-bold rounded-b">
                                                    ...
                                                    <th class="px-4 py-2 w-1/12 font-bold rounded-b">
